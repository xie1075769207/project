...
function ajax(option) {
  ...
  if (defOption.data) {
    ...
    var dataType = Object.prototype.toString.call(defOption.data);
    ...
    if (dataType == '[object Object]') {
      ...
      for (var _key in defOption.data) {
        str += _key + '=' + defOption.data[_key] + '&';
      }
  ...
  try {
    var xhr = new XMLHttpRequest(); // 判断请求的是类型 来写请求携带参数
